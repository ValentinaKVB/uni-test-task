...
function createTable() {
  ...
  for (let i = 0; i < testArray.length; i++) {
    const userId = testArray[i].userId;
    const postId = testArray[i].id;
    const postTitle = testArray[i].title;
    const postBody = testArray[i].body;
    ...
    if (i === 0 || (i > 0 && userId !== testArray[i - 1].userId)) {
